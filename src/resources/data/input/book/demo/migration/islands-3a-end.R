...
compare = function(df) {
	rabbit_initial = df[1, paste0("island", 0:2,".rabbit.rabbit.initial")]
	rabbit_total = tail(df[paste0("island", 0:2,".rabbit.rabbit.outflowTotal")], 1)
	...
	fox_initial = df[1, paste0("island", 0:2,".fox.fox.initial")]
	fox_total = tail(df[paste0("island", 0:2,".fox.fox.outflowTotal")], 1)
