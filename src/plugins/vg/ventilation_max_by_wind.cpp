...
*/
#include <stdlib.h>
#include "ventilation_max_by_wind.h"
#include "general.h"
...
VentilationMaxByWind::VentilationMaxByWind(QString name, QObject *parent)
    : Box(name, parent)
{
...
void VentilationMaxByWind::reset() {
    value = baseRate;
}

void VentilationMaxByWind::update() {
