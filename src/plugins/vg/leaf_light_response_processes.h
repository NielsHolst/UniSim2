...
*/
#ifndef LEAF_LIGHT_RESPONSE_PROCESSES
#define LEAF_LIGHT_RESPONSE_PROCESSES

#include <base/box.h>

namespace vg {

class LeafLightResponseProcesses : public base::Box
{
public:
    LeafLightResponseProcesses(QString name, QObject *parent);
    void reset();
    void update();
