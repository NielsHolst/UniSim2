...
MusselThinning::MusselThinning(Identifier name, QObject *parent)
    : Model(name, parent)
{
    new Parameter<double>("mBiomass", &mBiomass, 1., this, "current mussel density biomass g/m2");
    new Parameter<double>("mAbundance", &mAbundance, 1., this, "current mussel density numbers n/m2");
    new Parameter<double>("supply", &supply, 0., this, "biomass of mussesl consumed by starfish g/m2");
    new Parameter<double>("mSize", &mSize, 1, this, "current mussel size at step in g");
    new Variable<double>("lsAbundance", &lsAbundance, this, "mussel loss as numbers n/m2");
    new Variable<double>("lsBiomass", &lsBiomass, this, "mussel loss as biomass g/m2");
}
