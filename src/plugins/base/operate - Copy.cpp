...
template <> int    add_raw(int a, int b)       { return a+b; }
template <> double add_raw(int a, double b) { return a+b; }
template <> double add_raw(double a, int b) { return a+b; }
...
//        switch (b.type()) {
//        case Type::Int     :
//            const QVector<int> &A(a.value<QVector<int>>());
//            const         int  &B(b.value<        int >());
