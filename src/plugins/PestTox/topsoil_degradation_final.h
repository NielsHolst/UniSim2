...
class topsoildegradationfinal : public base::Box
{
public:
    topsoildegradationfinal(QString name, QObject *parent);
    void reset();
    void update();
...
private:
    ...
    // Output
    double concentration, outflow, degradation, volatilization, Ts,
