...
*/
#include "topsoil_degradation_final.h"
#include <cmath>
...
topsoildegradationfinal::topsoildegradationfinal(QString name, QObject *parent)
	: Box(name, parent)
{
    ...
    Output(outflow);
    Output(Ts);             //actual soil temp in deg C
