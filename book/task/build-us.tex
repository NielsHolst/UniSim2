In \iref{ch:your-first-model} you downloaded the \US\ \concept{Installer}. This installer put the \US\ application on your computer, together with a selection of box scripts. What was not included in the installer was the \US\ \concept{source code}.
