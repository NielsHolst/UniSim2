...
\caption{Observations from \iref{tab:phys-dev} (red dots) with regression line (brown), day-degree model (green lines) and Briere model (blue curve). Generated by the \filename{\inputfolder/book/phys-dev-scale.box} script.} 
