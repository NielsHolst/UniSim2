...
\newcommand{\devhomeexplained}[1]{{\protect\filename{\protect\devhome/#1}}\footnote{\protect\devhome\ is the developer's work folder (see \protect\iref{ch:conventions})}}

\newcommand{\outputfolderexplained}{\protect\outputfolder \footnote{\protect\outputfolder\ is your \protect\US\ output folder (see \protect\iref{ch:conventions})}}

% \definecolor{bittersweet}{HTML}{C04F17}

% \newcommand{\devhomeexplained}[1]{{\protect\filename{\protect\devhome/#1}}\footnote{\protect\devhome\ is the developer's work folder (see \protect\href{ch:developer-work-folder}{\color{bittersweet}{Conventions}})}}

% \newcommand{\outputfolderexplained}{\protect\outputfolder \footnote{\protect\outputfolder\ is your \protect\US\ output folder (see \protect\href{ch:developer-work-folder}{\color{bittersweet}{Conventions}})}}
